...
{
    public class P_MovementSkill : IState
    {
        ...
        public P_MovementSkill(GameObject gameObject, Animator animator, RaycastMousePosition raycaster, NavMeshAgent navMeshAgent, StateManager stateManager, SkillManager skill)
        {
